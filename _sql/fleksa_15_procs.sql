...
CREATE FUNCTION `add_user`(in_login varchar(150), in_email varchar(150), in_pass varchar(250)) RETURNS varchar(100) CHARSET utf8
    READS SQL DATA
BEGIN
...
CREATE FUNCTION `reg_user`(reg_token varchar(40), ip varchar(15), exist_token varchar(40)) RETURNS varchar(40) CHARSET utf8
    READS SQL DATA
BEGIN
